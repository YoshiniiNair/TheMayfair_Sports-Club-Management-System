                 ...
                 while($row = $result->fetch_assoc())
                 {
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><center><a href = "membership_edit.php?user_id=<?php echo $row['id']?>" class = "btn btn-warning"><span class = "glyphicon glyphicon-edit"></span>  Update</a> | <a  href = "delete_membership.php?user_id=<?php echo $row['id']?>" class = "btn btn-danger"><span class = "glyphicon glyphicon-trash"></span> Delete</a></center></td>
                      </tr>
